...
class TuringMachineGUI(tk.Tk):
    def __init__(self, tm):
        ...
        self.image_tabla = PhotoImage(file="suma/tabla.png")
        self.image_tabla = self.image_tabla.subsample(2) 
        self.image_tabla_label = tk.Label(self, image=self.image_tabla)
        self.image_tabla_label.pack(side=tk.TOP, pady=20)

        self.image_q0 = PhotoImage(file="suma/Q0V.png")
        self.image_q0 = self.image_q0.subsample(1)
    ...
    def update_image(self):
        ...
        if current_state == 'q0':
            image_path = f"suma/Q0{tape_color}.png"
        elif current_state == 'q1':
            image_path = f"suma/Q1{tape_color}.png"
        elif current_state == 'q2':
            image_path = f"suma/Q2{tape_color}.png"
        elif current_state == 'q3':
            image_path = f"suma/Q3{tape_color}.png"
        elif current_state == 'q4':
            image_path = f"suma/Q4{tape_color}.png"
        else:
            return
    ...
    def update_tabla_image(self):
        ...
        image_path = f"suma/Q{current_state}ENTRADA{current_symbol}.png"
        
        if os.path.exists(image_path):
            new_tabla_image = PhotoImage(file=image_path)
            new_tabla_image = new_tabla_image.subsample(2)
            self.image_tabla_label.configure(image=new_tabla_image)
            self.image_tabla_label.image = new_tabla_image
