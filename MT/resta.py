...
class TuringMachineGUI(tk.Tk):
    def __init__(self, tm):
        ...
        self.image_tabla = PhotoImage(file="resta/tabla.png")
        ...
        self.image_q0 = PhotoImage(file="resta/QINI.png")
    ...
    def update_image(self):
        ...
        if current_state == 'q0':
            image_path = f"resta/Q1{tape_color}.png"
        elif current_state == 'q1':
            image_path = f"resta/Q2{tape_color}.png"
        elif current_state == 'q2':
            image_path = f"resta/Q3{tape_color}.png"
        elif current_state == 'q3':
            image_path = f"resta/Q4{tape_color}.png"
        elif current_state == 'q4':
            image_path = f"resta/Q5{tape_color}.png"
        elif current_state == 'q5':
            image_path = f"resta/Q6{tape_color}.png"
        elif current_state == 'q6':
            image_path = f"resta/Q7{tape_color}.png"
        elif current_state == 'q7':
            image_path = f"resta/Q8{tape_color}.png"
        elif current_state == 'q8':
            image_path = f"resta/Q9{tape_color}.png"
        elif current_state == 'q9':
            image_path = f"resta/Q10{tape_color}.png"
        elif current_state == 'q10':
            image_path = f"resta/Q11{tape_color}.png"
        elif current_state == 'q11':
            image_path = f"resta/Q12{tape_color}.png"
        elif current_state == 'q12':
            image_path = f"resta/Q13{tape_color}.png"
        elif current_state == 'q13':
            image_path = f"resta/Q14{tape_color}.png"
        elif current_state == 'q14':
            image_path = f"resta/Q15{tape_color}.png"
        elif current_state == 'q15':
            image_path = f"resta/Q16{tape_color}.png"
        elif current_state == 'q16':
            image_path = f"resta/Q17{tape_color}.png"
        elif current_state == 'q17':
            image_path = f"resta/Q18{tape_color}.png"
        elif current_state == 'q18':
            image_path = f"resta/Q19{tape_color}.png"
        else:
            return
