...
class TuringMachineGUI(tk.Tk):
    def __init__(self, tm):
        ...
        self.image_tabla = PhotoImage(file="division/tabla.png")
        ...
        self.image_q0 = PhotoImage(file="division/QINI.png")
    ...
    def update_image(self):
        ...
        if current_state == 'q0':
            image_path = f"division/Q0{tape_color}.png"
        elif current_state == 'q1':
            image_path = f"division/Q1{tape_color}.png"
        elif current_state == 'q2':
            image_path = f"division/Q2{tape_color}.png"
        elif current_state == 'q3':
            image_path = f"division/Q3{tape_color}.png"
        elif current_state == 'q4':
            image_path = f"division/Q4{tape_color}.png"
        elif current_state == 'q5':
            image_path = f"division/Q5{tape_color}.png"
        elif current_state == 'q6':
            image_path = f"division/Q6{tape_color}.png"
        elif current_state == 'q7':
            image_path = f"division/Q7{tape_color}.png"
        elif current_state == 'q8':
            image_path = f"division/Q8{tape_color}.png"
        else:
            return
